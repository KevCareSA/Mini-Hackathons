...
function Hero() {
  return (
    ...
    <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 
        xl:px-32 text-white bg-[url("src/assets/heroImage.png")] bg-cover bg-center 
        bg-no-repeat h-screen'>
            <p className='bg-[#005461]/50 px-3 py-1 rounded-full mt-20 '>
                The Ultimate Hotel Experience
            </p>
            <h1 className='font-playfair text-2xl md:text-3xl md:text-[46px] md:leading-[56px] 
                font-bold md:font-extrabold max-w-xl mt-'>
                Welcome to Hotel KevCare 
            </h1>
